...
def insert_beta_match(self, match_idrecs):
    ...
    if(not was_match):
        outputs[0].change_set[idrec0] = u1(1)
        outputs[1].change_set[idrec1] = u1(1)
    return was_match
...
@njit(cache=True)
def _handle_beta_match(self, match_head_ptrs_func, match_inp_ptrs, match_idrecs):    

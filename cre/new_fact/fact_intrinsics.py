...
from cre.new_fact.member import MemberTypeClass
...
# from cre.new_fact.fact import _fact_get_mbr_data_ptr, _fact_get_attr_data_ptr
...
def _to_mbr(val, val_type, field_type): 
    ...
    if(isinstance(field_type, (ListType,))):
        ...
        def cast_obj(x):
            return Member(x)
        casted = context.compile_internal(builder, cast_obj, field_type(val_type,), (casted,))
